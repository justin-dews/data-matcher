-- Corrected test function for normalize_product_text - matches original plan
...
BEGIN
  ...
  RETURN QUERY SELECT 
    1::INTEGER,
    '  BOLT - M16X1.50  '::TEXT,
    'bolt-m16x1.50'::TEXT,  -- Keep hyphen as per original plan
  ...
  -- Test case 3: Hyphen handling - CORRECTED to match original plan
  RETURN QUERY SELECT
    3::INTEGER,
    'STEEL M8-1.25'::TEXT,
    'steel m8-1.25'::TEXT,  -- KEEP the hyphen as per original plan
